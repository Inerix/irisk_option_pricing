...
pkg_list = c("doParallel", "foreach", "bigmemory")

f = lapply(pkg_list, function(p){
...
nstep_price = 100 # delta_s <= 2a/abs(b)

# for 1 - stock case, convergence is delta_t <= 1/(sigma ** 2 * I ** 2)
